                                ...
                                <c:forEach var="detail" items="${productDetail}" begin="0" end="${period-1}" step="1" >
                               		...
                               		<input type='hidden' name="day" id="day" value='${detail.day}' >
	                                    ...
	                                    <div class="form-group">
	                                    	...
	                                    	<input class="form-control" name="dayTitle" id='day_title${detail.day}' type="text" 
		                                        value="${detail.day_title}" readonly="readonly">
	                                    </div>
                               		</div>
                               		 <div class="col-sm-12">
	                               		<div class='form-group'>
											...
											value='${detail.day_course}' readonly="readonly">
										</div>
									</div>
	                                <div class="col-sm-6">
	                                    <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
	                                    <div class="form-group">
	                                        ...
	                                        value="${detail.meal}" readonly="readonly">
	                                    </div>
	                                 </div>
	                                <div class="col-12">
	                                    <div class="form-group">
	                                    	<span>일정내용</span>
	                                        <textarea class="form-control w-100" name="dayContent" id='day_content${detail.day}' cols="30" rows="9" readonly="readonly">${detail.day_content}</textarea>
	                                    </div>
	                                </div>
                                  	<div class="col-12">
	                                    <div class="form-group">
	                                    	<span>이미지 설명</span>
	                                        <textarea class="form-control w-100" name="imgContent" id='img_content${detail.day}' cols="30" rows="9" readonly="readonly">${detail.img_content}</textarea>
	                                    </div>
	                                </div>
	                                <div class="col-12">
		                                <div class='form-group'>
